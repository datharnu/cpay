      ...
      {mode === "pick" ? (
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          >
            ...
            <p className="mt-3 font-semibold text-text-primary">Apply to partnership months</p>
            <p className="mt-1 text-sm text-text-secondary">
              Covers from their start month first, then spreads forward (e.g. ₦100 → July + August at ₦50/mo).
            </p>
